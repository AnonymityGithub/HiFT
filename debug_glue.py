...
from debug_trainer import GlueTrainer,GPUTrainer
...
SpecialLayers={
    "qa":["embeddings","qa_outputs"],
    "classification":["embeddings","classifier"],
    "multiplechoice":["embeddings","classifier"],
    "tokenclassification":["embeddings","classifier"],
}
...
class ModelArguments:
    ...
    hier_reverse: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to switch direction"
            )
        },
    )
...
def main():
    ...
    spLayers = SpecialLayers[model_args.task_type]
    ...
    model_class, tokenizer_class,model_config = AutoModelClassification(model_args.model_name_or_path)
    ...
    if model_args.hier_tuning:#hier_tuning
        trainer = GlueTrainer(
            ...
            optimizer_strategy = model_args.optimizer_strategy,
            hier_reverse = model_args.hier_reverse,
