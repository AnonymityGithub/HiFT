...
from llama.modeling_parallama import ModelParallelLLaMa
...
from trainer_generation import CustomSeq2SeqTrainer,GPUTrainer
...
MODEL_CLASSES = {
    ...
    "parallama":(ModelParallelLLaMa,LlamaTokenizer,LlamaConfig),
    "opt": (OPTForCausalLM, GPT2Tokenizer,OPTConfig),
}
#"llama": (LlamaForCausalLM, LlamaTokenizer,LlamaConfig),
SpecialLayers={
    "llama":["embed_tokens","norm","lm_head"],
    "parallama":["embed_tokens","norm","lm_head"],
    "gpt2":[r"w[^ ]e","ln_f"],
    "geo":[r"w[^ ]e","ln_f"],
}
...
def main():
    ...
    spLayers = SpecialLayers[model_args.model_type]
